			...
			<div class="food-wrapper">
				<div class="food-content">
					...
					<div class="content-wrapper">
						...
						<div class="buy" v-show="!food.count || food.count == 0" @click="addFirst">BUY</div>
					</div>
				</div>
				...
				<div class="rating-wrapper">
					...
					<div class="rating-content" v-if="food.rating">
...
.food .food-wrapper .food-content .cartcontroll-wrapper{
	position: absolute;
	right: 12px;
	bottom: 10px;
	padding: 2px;
